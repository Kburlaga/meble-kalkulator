...
def rysuj_element(szer, wys, id_elementu, nazwa, otwory=[], kolor_tla='#e6ccb3'):
    ...
    for otw in otwory:
        ...
        # --- POPRAWKA ETYKIET ---
        # Przesuwamy tekst o 12mm w prawo i 5mm w górę, żeby nie dotykał kropki
        if len(otwory) < 40:
            ax.text(x + 12, y + 5, f"({x:.1f}, {y:.1f})", fontsize=8, color=kolor, weight='bold', rotation=0)
...
with t2:
    # --- SEKCJA PDF (Działa na standardowych bibliotekach) ---
